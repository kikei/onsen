...
/***/ function(module, exports, __webpack_require__) {
	...
	var OnsenAddressInputReducer_1 = __webpack_require__(33);
	var OnsenAddressInput_1 = __webpack_require__(36);
	...
	var App = react_redux_1.connect(function (state) {
	    return { state: state };
	})(OnsenAddressInput_1.OnsenAddressInput);
	var root = document.getElementById("form-onsen-address-container");
	var store = createStoreWithMiddleware(OnsenAddressInputReducer_1.app);
	function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function app(state, action) {
	    if (state === void 0) { state = Models_1.InitialOnsenAddressState; }
	    switch (action.type) {
	        case Models_1.ActionType.ChangeAddressText:
	            return changeAddressText(state, action);
	        case Models_1.ActionType.ChangeMapCenter:
	            return changeMapCenter(state, action);
	        case Models_1.ActionType.ChangeLocation:
	            return changeLocation(state, action);
	        case Models_1.ActionType.SwitchAddressSelectMethod:
	...
	exports.app = app;
	function changeAddressText(state, action) {
	    return assign({}, state, {
	        address: action.payload
	    });
	}
	function changeMapCenter(state, action) {
	...
	function switchAddressSelectMethod(state, action) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Models_1 = __webpack_require__(34);
	var OnsenAddressInput = (function (_super) {
	    __extends(OnsenAddressInput, _super);
	    function OnsenAddressInput() {
	        _super.apply(this, arguments);
	    }
	    OnsenAddressInput.prototype.handleChange = function (e) {
	        console.log(e.target.value);
	        var address = e.target.value;
	        console.debug('chane address address =' + address);
	        this.props.dispatch({ type: Models_1.ActionType.ChangeAddressText,
	            payload: address });
	    };
	    OnsenAddressInput.prototype.selectByMap = function (e) {
	        var _this = this;
	        e.preventDefault();
	        ...
	        if (!address) {
	            ...
	            this.props.dispatch({ type: Models_1.ActionType.ChangeMapCenter,
	                payload: latlng });
	            this.props.dispatch({ type: Models_1.ActionType.SwitchAddressSelectMethod,
	                payload: Models_1.AddressSelectMethod.byMap });
	        }
	        else {
	                ...
	                $.ajax({
	                    ...
	                    success: function (msg) {
	                        ...
	                        if (msg.latitude && msg.longitude) {
	                            dispatch({ type: Models_1.ActionType.ChangeMapCenter,
	                                payload: msg });
	                            _this.props.dispatch({ type: Models_1.ActionType.SwitchAddressSelectMethod,
	                                payload: Models_1.AddressSelectMethod.byMap });
	                        }
	                    },
	    ...
	    OnsenAddressInput.prototype.enterMapModal = function () {
	        ...
	        this.props.dispatch(function (dispatch) {
	            ...
	            google.maps.event.addListener(map, 'click', function (evt) {
	                ...
	                var location = new Models_1.LatLng(latitude, longitude);
	                dispatch({ type: Models_1.ActionType.ChangeLocation, payload: location });
	            });
	        });
	        this.props.dispatch({ type: Models_1.ActionType.SetMap, payload: map });
	    };
	    OnsenAddressInput.prototype.registerAddress = function () {
	        console.log('register address');
	        var latitude = this.props.state.location.latitude;
	        var longitude = this.props.state.location.longitude;
	        this.props.dispatch(function (dispatch) {
	            ...
	            $.ajax({
	                ...
	                success: function (msg) {
	                    console.log(msg);
	                    if (msg) {
	                        dispatch({ type: Models_1.ActionType.ChangeAddressText,
	                            payload: msg });
	                        dispatch({ type: Models_1.ActionType.SwitchAddressSelectMethod,
	                            payload: Models_1.AddressSelectMethod.byText });
	                    }
	                },
	                error: function (e) { console.error(e); }
	            });
	    ...
	    OnsenAddressInput.prototype.hideMapModal = function () {
	        console.log('hide map modal');
	        this.props.dispatch({ type: Models_1.ActionType.SwitchAddressSelectMethod,
	            payload: Models_1.AddressSelectMethod.byText });
	    };
	    OnsenAddressInput.prototype.render = function () {
	        var state = this.props.state;
	        var showModal = state.selectMethod == Models_1.AddressSelectMethod.byMap;
	        var h3 = state.location ?
	            state.location.toString() : '温泉の位置をクリックして下さい';
	        var MapModal = React.createElement(react_bootstrap_1.Modal, {bsSize: "large", show: showModal, onEnter: this.enterMapModal.bind(this), onHide: this.hideMapModal.bind(this)}, React.createElement(react_bootstrap_1.Modal.Header, {closeButton: true}, React.createElement(react_bootstrap_1.Modal.Title, null, "地図から入力する")), React.createElement(react_bootstrap_1.Modal.Body, null, React.createElement("h3", null, h3), React.createElement("div", {className: "map-container"}, React.createElement("div", {id: "map", "data-zoom": "14", style: { height: '300px' }}))), React.createElement(react_bootstrap_1.Modal.Footer, null, React.createElement(react_bootstrap_1.Button, {onClick: this.registerAddress.bind(this)}, "ここに登録する"), React.createElement(react_bootstrap_1.Button, {onClick: this.hideMapModal.bind(this)}, "キャンセル")));
	        return (React.createElement("div", null, React.createElement(react_bootstrap_1.FormControl, {type: "text", name: "address", label: "from-onsen-address", ref: "address", placeholder: "○○県○○市○○町", value: state.address, onChange: this.handleChange.bind(this)}), React.createElement(react_bootstrap_1.Button, {bsStyle: "link", bsSize: "small", onClick: this.selectByMap.bind(this)}, "地図から入力する"), MapModal));
	    };
	    return OnsenAddressInput;
	}(React.Component));
	exports.OnsenAddressInput = OnsenAddressInput;
...
/***/ }
/******/ ]);
//# sourceMappingURL=onsen_edit_form.js.map